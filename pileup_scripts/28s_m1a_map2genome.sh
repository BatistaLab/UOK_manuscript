...
mkdir -p 28s_genomemapped_STAR2.7.6a
...
STAR \
    ...
    --outFileNamePrefix 28s_genomemapped_STAR2.7.6a/$OUTNAME \

# sbatch --array=0-11 --partition=ccr --cpus-per-task=4 --mem=50g --gres=lscratch:20 28s_m1a_map2genome.sh
