...
mpileup -d 100000000 -f /data/maligireddyss/repeat_index_star2.7.6a/repeatRNA.fa -a INFO/AD /data/maligireddyss/18s_pileup/18s_repeat_BC10_1Aligned.sortedByCoord.out.bam