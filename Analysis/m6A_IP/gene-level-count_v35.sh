...
module load htseq
htseq-count -m union -s yes -f bam -r pos -t exon -i gene_id /data/BatistaLab_NGS/UOK_manuscript/m6AIP/262_genome_map/STAR2.7.6a/$INPUT.sortedByCoord.out.bam /data/BatistaLab_NGS/annotations/v35/gencode.v35.annotation.gtf > /data/BatistaLab_NGS/UOK_manuscript/m6AIP/262_readcounts/peak_counts/$OUTNAME.strand-yes.gene-level.count
