...
singularity exec docker://tobneu/slamdunk:latest slamdunk all /data/BatistaLab_NGS/UOK_manuscript/SLAMseq/02_SLAMDUNK_pipeline/Library2_manifest_mutant_v27.tsv \
  ...
  -o /data/BatistaLab_NGS/UOK_manuscript/SLAMseq/02_SLAMDUNK_pipeline/gencodeV35_multimap_mut \
